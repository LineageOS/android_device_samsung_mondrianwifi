...
void custom_init_data(){
    ...
    change_table_data(SND_DEVICE_IN_CAMCORDER_MIC, "camcorder-mic");
    ...
    change_table_data(SND_DEVICE_IN_HANDSET_STEREO_DMIC, "rec-main-mic");
    change_table_data(SND_DEVICE_IN_SPEAKER_STEREO_DMIC, "rec-main-mic");
}
